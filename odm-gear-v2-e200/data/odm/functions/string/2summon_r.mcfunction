...
execute at @s run summon minecraft:armor_stand ~ ~1 ~ {NoGravity:1b,Invulnerable:1b,Invisible:1b,Tags:["string","p","right","new"],ArmorItems:[{},{},{},{id:'minecraft:paper',Count:1b,tag:{CustomModelData:10002}}]}
