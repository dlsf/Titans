...
execute store result entity @s Motion[0] double 0.04 run scoreboard players operation @s m_x2 -= @s m_x1
execute store result entity @s Motion[1] double 0.04 run scoreboard players operation @s m_y2 -= @s m_y1
execute store result entity @s Motion[2] double 0.04 run scoreboard players operation @s m_z2 -= @s m_z1
