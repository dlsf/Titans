playsound minecraft:odm.shoot master @a[distance=..10] ^ ^ ^ 1.5 1
execute rotated ~ 0 run particle dust 1.000 1.000 1.000 2 ^0.4 ^0.8 ^0.6 0 0 0 0 10 force
execute rotated ~ 0 run particle dust 1.000 1.000 1.000 2 ^-0.4 ^0.8 ^0.6 0 0 0 0 10 force
...
execute at @s run summon minecraft:armor_stand ~ ~1 ~ {NoGravity:1b,Invulnerable:1b,Invisible:1b,Tags:["string","new"],ArmorItems:[{},{},{},{id:'minecraft:paper',Count:1b,tag:{CustomModelData:10001}}]}
