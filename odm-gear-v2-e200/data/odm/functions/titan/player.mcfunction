...
replaceitem entity @s[scores={animation=0}] armor.head minecraft:ink_sac{CustomModelData:20000,titan_item:1b}
replaceitem entity @s[scores={animation=1..2}] armor.head minecraft:ink_sac{CustomModelData:20001,titan_item:1b}
replaceitem entity @s[scores={animation=3..4}] armor.head minecraft:ink_sac{CustomModelData:20002,titan_item:1b}
replaceitem entity @s[scores={animation=5..6}] armor.head minecraft:ink_sac{CustomModelData:20003,titan_item:1b}
replaceitem entity @s[scores={animation=7..8}] armor.head minecraft:ink_sac{CustomModelData:20004,titan_item:1b}
replaceitem entity @s[scores={animation=9..10}] armor.head minecraft:ink_sac{CustomModelData:20005,titan_item:1b}
replaceitem entity @s[scores={animation=11..12}] armor.head minecraft:ink_sac{CustomModelData:20006,titan_item:1b}
replaceitem entity @s[scores={animation=13..14}] armor.head minecraft:ink_sac{CustomModelData:20007,titan_item:1b}
replaceitem entity @s[scores={animation=15..16}] armor.head minecraft:ink_sac{CustomModelData:20004,titan_item:1b}
