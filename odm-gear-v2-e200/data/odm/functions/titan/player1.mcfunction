...
replaceitem entity @s[scores={animation=0}] armor.head minecraft:ink_sac{CustomModelData:30000,titan_item:1b}
replaceitem entity @s[scores={animation=1..2}] armor.head minecraft:ink_sac{CustomModelData:30001,titan_item:1b}
replaceitem entity @s[scores={animation=3..4}] armor.head minecraft:ink_sac{CustomModelData:30002,titan_item:1b}
replaceitem entity @s[scores={animation=5..6}] armor.head minecraft:ink_sac{CustomModelData:30003,titan_item:1b}
replaceitem entity @s[scores={animation=7..8}] armor.head minecraft:ink_sac{CustomModelData:30004,titan_item:1b}
replaceitem entity @s[scores={animation=9..10}] armor.head minecraft:ink_sac{CustomModelData:30005,titan_item:1b}
replaceitem entity @s[scores={animation=11..12}] armor.head minecraft:ink_sac{CustomModelData:30006,titan_item:1b}
replaceitem entity @s[scores={animation=13..14}] armor.head minecraft:ink_sac{CustomModelData:30007,titan_item:1b}
replaceitem entity @s[scores={animation=15..16}] armor.head minecraft:ink_sac{CustomModelData:30004,titan_item:1b}
