package net.dasunterstrich.aot.configuration;

import net.dasunterstrich.aot.configuration.types.IConfiguration;
...
public final class ConfigurationProvider {
    ...
    private final static ConfigurationProvider instance;
    ...
    /**
     * Returns the Int value of the provided config entry.
     *
     * @param configEntry The config entry which should be accessed.
     * @return The value of the config entry.
     */
    public int getInt(IConfiguration configEntry) {
        var configFile = configurationFiles.get(configEntry.getClass());
        return configFile.getInt(configEntry.getConfigKey());
    }

    /**
     * Returns the Double value of the provided config entry.
     *
     * @param configEntry The config entry which should be accessed.
     * @return The value of the config entry.
     */
    public double getDouble(IConfiguration configEntry) {
        var configFile = configurationFiles.get(configEntry.getClass());
        return configFile.getDouble(configEntry.getConfigKey());
    }

    /**
     * Returns the Boolean value of the provided config entry.
     *
     * @param configEntry The config entry which should be accessed.
     * @return The value of the config entry.
     */
    public boolean getBoolean(IConfiguration configEntry) {
        var configFile = configurationFiles.get(configEntry.getClass());
        return configFile.getBoolean(configEntry.getConfigKey());
    }
    ...
    public <T> T get(IConfiguration configEntry, Class<T> clazz) {
        var configFile = configurationFiles.get(configEntry.getClass());

        return clazz.cast(configFile.get(configEntry.getConfigKey()));
    }
