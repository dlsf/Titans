...
public class YellowFlareGun extends FlareGun {
    ...
    public YellowFlareGun() {
        super("YellowFlareGun", Color.YELLOW);
    }
    ...
    public ItemStack getItemStack() {
        return new ItemBuilder(Material.CARROT_ON_A_STICK)
                .name(configurationProvider.getString(MainConfig.ITEM_YELLOW_FLARE_NAME))
